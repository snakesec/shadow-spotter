...
13" this yields the following results.
	...
	goos: darwin
	goarch: amd64
	pkg: gitlab.com/snake-security/shadowspotter/pkg/kiterunner
	...
	PASS
	ok      gitlab.com/snake-security/shadowspotter/pkg/kiterunner  8.170s
...
This concurrency model was selected based on the benchmarks run in gitlab.com/snake-security/shadowspotter/benchmark/concurrency_test.go
